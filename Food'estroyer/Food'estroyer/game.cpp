...
void Game::update() {
	...
	if (levelOneOn) {
		...
		for (Shooter& shooter : vectorShooter) {
			shooter.behavior(vectorShooter, shooterPositions, projectiles);
		}
